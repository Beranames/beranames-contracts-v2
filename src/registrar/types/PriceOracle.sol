...
contract PriceOracle is IPriceOracle {
        ...
        returns (uint256 base, uint256 discount)
    {
        ...
        if (nameLength == 1) {
            pricePerYear = 420_000_000; // 1 character
        } else if (nameLength == 2) {
            pricePerYear = 269_000_000; // 2 characters
        } else if (nameLength == 3) {
            pricePerYear = 169_000_000; // 3 characters
        } else if (nameLength == 4) {
            pricePerYear = 69_000_000; // 4 characters
        } else {
            pricePerYear = 25_000_000; // 5+ characters
        }
