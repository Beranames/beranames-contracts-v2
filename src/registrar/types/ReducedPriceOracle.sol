...
// DO NOT USE THIS ON MAINNET - prices are 1 / 1.000.000th of the actual price
// very useful for testing

contract ReducedPriceOracle is IPriceOracle, Ownable {
        ...
        returns (uint256 base, uint256 discount)
    {
        ...
        if (nameLength == 1) {
            pricePerYear = 420; // 1 character 420$
        } else if (nameLength == 2) {
            pricePerYear = 269; // 2 characters 269$
        } else if (nameLength == 3) {
            pricePerYear = 169; // 3 characters 169$
        } else if (nameLength == 4) {
            pricePerYear = 69; // 4 characters 69$
        } else {
            pricePerYear = 25; // 5+ characters 25$
        }
